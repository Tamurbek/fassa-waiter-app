...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ru_RU': {
          ...
          'category_report': 'Отчет по категориям',
          ...
          'payment_method_report': 'Отчет по методам оплаты',
          'preparation_areas': 'Зоны приготовления',
          'pricing': 'Цена',
          'sales_report': 'Отчет по продажам',
          'show_instagram_qr': 'Показывать Instagram QR',
          'show_phone_on_receipt': 'Показывать телефон в чеке',
          'TAYYOR': 'ГОТОВО',
          'tayyor': 'Готово',
          'variant_name': 'Название варианта',
          'waiter_performance': 'Производительность официантов',
          'x_report': 'X-Отчет',
          'z_report': 'Z-Отчет',
        }
      };
